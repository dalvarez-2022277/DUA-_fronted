...
export const Search = ({ searchTerm, setSearchTerm, filteredItems, onSearch }) => {
    ...
    const handleItemClick = (item) => {
        // Aquí puedes manejar la lógica para cuando se hace clic en un elemento de la lista de recomendaciones
        // Por ejemplo, podrías establecer el término de búsqueda al título del ítem y realizar una búsqueda
