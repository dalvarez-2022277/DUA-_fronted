            ...
            <div className="mt-2 container mx-auto flex justify-between items-center text-white">
                <div className="hidden lg:flex space-x-4">
                  <NavButton text="Inicio" className="p-2 hover:text-gray-300 transition duration-300 font-mono" onClickHandler={handleNavigateToLema} />
                   ...
                   <NavButton text="Historial" className="p-2 hover:text-gray-300 transition duration-300 font-mono" onClickHandler={hableNavigateToListMy} />
                </div>
